...
export default function Footer() {
  ...
  return (
    <footer ref={containerRef} className="flex justify-center">
      <span className="flex align-center">
        Coded & Designed by Nadav Ben Hur using{' '}
        <SkillPreview skillObj={reactSkill} isRef={false} />{' '}
        <SkillPreview skillObj={reduxSkill} isRef={false} />
      </span>
    </footer>
  )
}
